...
if __name__ == '__main__':
    ...
    #bow_cluster_country_tourist_hotel.do('booking_keywords.txt',all=True)
    ...
    #frequence_difference_bow_creator.filterallsep('booking_keywords.txt',toptokens=True,all=False)
    frequence_difference_bow_creator.filterallsep('booking_keywords.txt',toptokens=False,all=True)
